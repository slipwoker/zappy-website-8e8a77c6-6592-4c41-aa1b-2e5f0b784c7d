  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if (minLength && !validators.minLength(value, minLength)) {
        showError(field, customMessage || 'Minimum ' + minLength + ' characters required.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8e8a77c6-6592-4c41-aa1b-2e5f0b784c7d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8e8a77c6-6592-4c41-aa1b-2e5f0b784c7d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8e8a77c6-6592-4c41-aa1b-2e5f0b784c7d';
